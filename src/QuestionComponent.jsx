export default function QuestionComponent({ questionId, question }) {
  return (
    <section className="flex place-content-center m-4">
      <div className="overflow-hidden bg-slate-900 text-slate-300 min-w-full">
        <div className="px-4 py-5 sm:px-6">
          ...
          <h2>{question}</h2>
          <input className="block w-full flex-1 rounded-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" type="text" />
